...
/*
 * Custom NovaThor SimReady RIL for Snda Radio
 *
 * {@hide}
 */
public class SndaU8500RIL extends RIL implements CommandsInterface {
    public SndaU8500RIL(Context context, int networkMode, int cdmaSubscription) {
